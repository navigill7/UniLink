...
const registerSchema = yup.object().shape({
  ...
  password: yup.string()
    .matches(strongPasswordRegex, "Password must contain at least 8 characters, one uppercase letter, one lowercase letter, one number, and one special character")
    .required("Password is required"),
  location: yup.string().required("Location is required"),
  Year: yup.string().required("Graduation Year is required"),
  picture: yup.string().url("Invalid URL format for picture").required("Picture URL is required")
});
